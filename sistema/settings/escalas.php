...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['accion'] ?? '') === 'guardar') {
    ...
    if ($id > 0) {
        ...
        redirigirConMensaje('escalas.php', 'ok', 'Escala actualizada.');
    } else {
        ...
        redirigirConMensaje('escalas.php', 'ok', 'Escala registrada.');
    }
}
...
<div class="row g-3">
    <div class="col-lg-4">
        <div class="card-panel">
            ...
            <form method="post" id="formEscala">
                    ...
                    <?php foreach ($escalas as $e): ?>
                        <tr>
                            ...
                            <td class="text-nowrap">
                                ...
                                <a href="escalas.php?toggle=<?= $e['id'] ?>" class="btn btn-sm btn-outline-secondary" onclick="return confirmarAccion('¿Cambiar el estado de esta escala?')"><i class="bi bi-toggle2-on"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
